...
#Import Gudz
RUN wget https://raw.githubusercontent.com/ophuok/Black-Lightning/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/ophuok/Black-Lightning/master/requirements.txt
#Start Fumkin
